...
public class ObjectPlacer : MonoBehaviour
{
    ...
    [Tooltip("The desired size of wide building in the world.")]
    public Vector3 WideBuildingSize = new Vector3(1.0f, .5f, .5f); //Remove?
    ...
    void Start()
    {
        ...
        if (DrawDebugBoxes)
        {
            this._boxDrawing = new BoxDrawer(gameObject);
        }
    }
    ...
    void Update()
    {
        ...
        {
            this._boxDrawing.UpdateBoxes(_lineBoxList);
        }
    }
    ...
    public void CreateScene()
    {
        ...
        List<PlacementQuery> queries = CreateLocationQueriesForSolver(1, this.WideBuildingSize, ObjectType.WideBuilding);
    ...
    private void CreateWideBuilding(Vector3 positionCenter, Quaternion rotation)
    {
        ...
        if (newObject != null)
        {
            ...
            //Set the parent of the new object to the GameObject ir was placed on
    ...
    private List<PlacementQuery> CreateLocationQueriesForSolver(int desiredLocationCount, Vector3 boxFullDimension, ObjectType objType)
    {
        List<PlacementQuery> placementQueries = new List<PlacementQuery>();

        var halfBoxDims = boxFullDimension * .5f;
